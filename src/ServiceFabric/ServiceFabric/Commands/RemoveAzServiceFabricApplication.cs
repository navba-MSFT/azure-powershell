...
namespace Microsoft.Azure.Commands.ServiceFabric.Commands
{
    ...
    public class RemoveAzServiceFabricApplication : ProxyResourceCmdletBase
    {
        ...
        [Parameter(Mandatory = false, ParameterSetName = ByResourceGroup, HelpMessage = "Returns True if the command succeeds and False if it fails. By default, this cmdlet does not return any output.")]
        [Parameter(Mandatory = false, ParameterSetName = ByInputObject, HelpMessage = "Returns True if the command succeeds and False if it fails. By default, this cmdlet does not return any output.")]
        [Parameter(Mandatory = false, ParameterSetName = ByResourceId, HelpMessage = "Returns True if the command succeeds and False if it fails. By default, this cmdlet does not return any output.")]
